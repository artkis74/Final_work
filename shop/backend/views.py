    ...
    def post(self, request, *args, **kwargs):
        ...
        if {'first_name', 'last_name', 'email', 'password', 'company', 'position'}.issubset(request.data):
            ...
            try:
                ...
                # request.data.update({}) # Добавляем пустой словарь, чтобы создать копию request.data,
                # для того чтобы когда будем сохранять экзампляр класса UserSerializer не сохранить пароль в незашифрованном виде
